...
import type { ProposalFieldV1, WeekActivityV1, WeekConfigurationV1 } from "./week.js";
...
export interface PrivateProposalV1 {
  v: 1;
...
export interface SchedulePlacementV1 {
  id: string;
  proposal_id: string;
  activity_id: string;
  starts_at: string;
...
export interface PrivateScheduleV1 {
  v: 1;
  ...
  placements: SchedulePlacementV1[];
  updated_at_ms: number;
}
...
export interface WeekArchiveV1 {
  v: 1;
  ...
  public_schedule: PublicScheduleV1 | null;
}
...
export function parsePrivateProposal(value: unknown): PrivateProposalV1 | null {
  ...
  return value as unknown as PrivateProposalV1;
}
...
export function parsePrivateSchedule(value: unknown): PrivateScheduleV1 | null {
  ...
  const schedule = value as unknown as PrivateScheduleV1;
...
export function scheduleWarnings(schedule: PrivateScheduleV1, configuration: WeekConfigurationV1): string[] {
...
export function configurationForArchive(configuration: WeekConfigurationV1): WeekArchiveV1["configuration"] {
